                                ...
                                <div class="in-padding-horizontal@s">
                                    ...
                                    <form class="uk-grid uk-form">
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input class="uk-input uk-border-rounded" name="user" value="" type="text" placeholder="Username">
                                        </div>
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            <span class="uk-form-icon uk-form-icon-flip fas fa-lock fa-sm"></span>
                                            <input class="uk-input uk-border-rounded" name="pass" value="" type="password" placeholder="Password">
                                        </div>
